import { MapContainer, TileLayer, CircleMarker, Circle, Popup, ScaleControl, ZoomControl, useMap } from 'react-leaflet';
        ...
        {clusterMarkers.map((cluster) => {
          ...
          return (
            <Fragment key={cluster.cluster_id}>
              {/* True geographic footprint of the cluster, in meters */}
              <Circle
                ...
                <Popup>
                  <div style={{ color: '#1e293b', minWidth: 180, fontFamily: 'Inter, sans-serif' }}>
                    ...
                    <p style={{ fontSize: 12, margin: '2px 0' }}>
                      <strong>Cluster:</strong> #{cluster.cluster_id + 1}
                    </p>
                    <p style={{ fontSize: 12, margin: '2px 0' }}>
                    ...
                    <p style={{ fontSize: 12, margin: '2px 0' }}>
                      <strong>Risk Score:</strong> {cluster.risk_score}
                    </p>
                    <p style={{ fontSize: 12, margin: '2px 0' }}>
                      <strong>Cluster Severity:</strong> {level}
                    </p>
                    <p style={{ fontSize: 12, margin: '2px 0' }}>
